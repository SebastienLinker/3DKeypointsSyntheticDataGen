...
default_hooks = dict(
    ...
    checkpoint=dict(
        ...
        save_best='MPJPE',
        type='CheckpointHook'),
    logger=dict(interval=250, type='LoggerHook'),
...
launcher = 'none'
load_from = 'work_dirs/cfg/epoch_200.pth'
log_level = 'INFO'
log_processor = dict(
...
test_dataloader = dict(
    batch_size=64,
    dataset=dict(
        ann_file=H36M_ROOT + 'augmented_valid.npz',
        causal=True,
...
train_dataloader = dict(
    batch_size=64,
    dataset=dict(
        ann_file=H36M_ROOT + 'augmented_train.npz',
        causal=True,
        data_prefix=dict(img='images/'),
        data_root='data/h36m/',
        keypoint_2d_src='gt',
